...
This project is indexed by GitNexus as **AI-WorkSpace** (49499 symbols, 92320 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
