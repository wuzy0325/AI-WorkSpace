...
This project is indexed by GitNexus as **AI-WorkSpace** (47402 symbols, 94564 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
