...
This project is indexed by GitNexus as **AI-WorkSpace** (46315 symbols, 85724 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
