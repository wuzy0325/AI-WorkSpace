...
This project is indexed by GitNexus as **AI-WorkSpace** (47271 symbols, 94494 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
