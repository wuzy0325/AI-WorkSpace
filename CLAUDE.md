...
This project is indexed by GitNexus as **AI-WorkSpace** (50180 symbols, 99999 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
