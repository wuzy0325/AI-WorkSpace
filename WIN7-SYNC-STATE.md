...
| 2026-08-18 | wispa | `e2c0800` | Go 1.20.14 build 通过；前端 build 通过；Electron/NSIS 打包通过 | 全新安装定位到 `%LOCALAPPDATA%\Programs\WISPA-win7`；backend /api/health 200；安装包文件名小写；Win7 真机验证待执行 | `6CA67D59478BEF5BCF028DB2138F6579FC5AC6748C349DA0296085B162855D8A` |
| 2026-08-18 | wista | `e2c0800` | Go 1.20.14 build 通过；前端 build 通过；Electron/NSIS 打包通过 | 全新安装定位到 `%LOCALAPPDATA%\Programs\WISTA-win7`；backend /api/health 200；安装包文件名小写；Win7 真机验证待执行 | `3479762C56218241364C08446B6B62013CAF1961E4567002CA925153A1339996` |
