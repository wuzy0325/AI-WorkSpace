...
| 2026-08-18 | WindLabX4 | `39baa0a` | Go 1.20.14 build 通过；前端 typecheck/build 通过；Electron/NSIS 打包通过；安装目录 `%LOCALAPPDATA%\Programs\WindLabX4-win7` 验证通过 | 本机 smoke 通过：/api/health 200；端口占用时 backend 退出码 2（防止前端连旧实例）；全新安装定位到 WindLabX4-win7 目录；Win7 真机验证待执行 | `583FBB3E586CE6F3BBE4D97FE868E3DD7042A81B446E0951FCE7B3C9F7B043A3` |
