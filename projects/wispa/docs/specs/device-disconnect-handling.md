...
改进 daq-p1604 在采集过程中遇到网络中断（拔网线）时的处理逻辑，解决三个核心缺陷：
...
**目标用户**：daq-p1604 桌面应用运维人员（实验室环境，单设备或多设备并发采集）
...
```powershell
# 构建（daq-p1604 隔离工作空间，必须 GOWORK=off）
...
参考现有 [p1604_adapter.go](file:///c:/Users/wuzhy/Documents/D/SVN/SoftWare/trunk/AI-Workspace/projects/daq-p1604/apps/desktop-wails/adapters/hardware/p1604_adapter.go) 风格。
