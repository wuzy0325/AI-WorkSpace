...
Standalone Wails desktop application for WISPA pressure data acquisition, monitoring, and CSV recording.
...
Real hardware mode only. Configure a WISPA profile in the app with the device IP and port (default 9000).
...
- `shared/device-sdk/go/protocol` 包含 WISPA 协议帧解析、单位转换、连接 helper 等跨项目复用代码。
