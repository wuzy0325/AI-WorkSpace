...
const zh = {
  ...
  'app.windowTitle': 'WISPA 温特纳智能压力扫描应用',
  // 退出应用确认框文案（MainTopBar 退出按钮触发，确认后调用后端 ExitApplication）
  'app.confirmExitTitle': '退出应用',
  'app.confirmExitText': '确认退出 WISPA 吗？未保存的录制将被正常关闭并落盘。',
  'app.exit': '退出',
  ...
  'monitor.selectDeviceHint': '从左侧设备列表中选择一台 P1604，或者点击设备列表上方 + 添加新设备',
  ...
  'monitor.config': '配置',
  'monitor.zeroCalibration': '校零',
  'monitor.connectBeforeZero': '请先连接设备再校零',
...
const en = {
  ...
  // ---- app-level ----
  'app.windowTitle': 'WISPA Pressure Acquisition',
  'app.confirmExitTitle': 'Exit Application',
  'app.confirmExitText': 'Exit WISPA? Any in-progress recording will be flushed and closed.',
  'app.exit': 'Exit',
  ...
  'monitor.selectDeviceHint': 'Pick a P1604 from the device list, or click + above the list to add a new one',
  ...
  'monitor.zeroCalibration': 'Zero Calibration',
  'monitor.connectBeforeZero': 'Connect the device before zeroing',
