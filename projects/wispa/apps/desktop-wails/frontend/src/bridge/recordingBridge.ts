...
//
// 与 wista Win7 版的差异：
//   - 多了 startRecordingWithConfig 端点（wispa 录制支持 FileRotation + StopConditions）
//   - 没有 recording-fatal / recording-backpressure 事件（wispa 的 CSVRecorder
 ...
 * @param filePrefix 文件名前缀（如 "wispa"）
 */
