"""
wispa E2E 测试脚本（基于 test-cases.html 194 个测试用例）
...
KNOWN_DEVICE_IP = os.environ.get("wispa_TEST_IP", "192.168.1.7")
KNOWN_DEVICE_PORT = int(os.environ.get("wispa_TEST_PORT", "9000"))
KNOWN_DEVICE_NAME = os.environ.get("wispa_TEST_NAME", "E2E测试设备")
...
def main() -> int:
    ...
    config_path = Path(os.environ.get("APPDATA", "")) / "wispa" / "device-profiles.json"
