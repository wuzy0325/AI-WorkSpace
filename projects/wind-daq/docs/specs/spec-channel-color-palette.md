...
### 我们在解决什么问题
Wind-DAQ 设备详情面板的 DAQ-P-1603 设备波形图和数值卡片缺乏颜色区分。
...
- Vitest 4（单元测试）
- 目标：仅 `projects/wind-daq`，不动 `daq-t1603` / `daq-p1604` / `shared/`
...
| 8 | 人工验证 | 启动 wind-daq，添加 DAQ-P-1603 设备，16 通道全压力下波形图和数值卡片颜色互不重色 |
