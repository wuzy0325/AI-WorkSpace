...
- `projects/wind-daq/services/api-go/internal/usecase/traversal_motion_safety_test.go`（新建）
...
**Files likely touched:**
- `projects/wind-daq/services/api-go/internal/usecase/traversal_motion_watchdog.go`（新建）
- `projects/wind-daq/services/api-go/internal/usecase/traversal_motion_safety_test.go`
...
- `projects/wind-daq/services/api-go/internal/usecase/traversal_*_test.go`（fake 实现补方法）
...
**Files likely touched:**
- `projects/wind-daq/services/api-go/internal/core/traversal/types.go`
- `projects/wind-daq/services/api-go/internal/core/traversal/errors.go`
...
- `projects/wind-daq/services/api-go/internal/usecase/traversal_helpers.go`（`motionTargetsReached` 签名）
- `projects/wind-daq/services/api-go/internal/usecase/traversal_motion_safety_test.go`
...
**Files likely touched:**
- `projects/wind-daq/services/api-go/internal/usecase/traversal_acquisition.go`
- `projects/wind-daq/services/api-go/internal/usecase/traversal_*_test.go`（更新 mock 期望）
...
**Files likely touched:**
- `projects/wind-daq/services/api-go/internal/usecase/traversal_checkpoint.go`
- `projects/wind-daq/services/api-go/internal/usecase/traversal_motion_safety_test.go`
...
**Files likely touched:**
- `projects/wind-daq/apps/desktop-wails/frontend/src/types/traversal.ts`
- `projects/wind-daq/apps/desktop-wails/frontend/src/stores/traversalStore.ts`
- `projects/wind-daq/apps/desktop-wails/frontend/wailsjs/`（自动生成）
...
**Description**: 在 `apps/desktop-wails/frontend/src/views/traversal/` 新建 `MotionSafetyPanel.vue`，提供全局阈值输入（到位容差/严重偏离/无进展超时/进展阈值）和按轴覆盖表格；遵循 wind-daq 全局配置规范（§35：120px 标签列 + 1fr 控件列，紧凑密度）；在遍历配置页运动绑定区域附近挂载。
...
**Files likely touched:**
- `projects/wind-daq/apps/desktop-wails/frontend/src/views/traversal/MotionSafetyPanel.vue`（新建）
- `projects/wind-daq/apps/desktop-wails/frontend/src/views/traversal/TraversalConfigView.vue`（挂载点）
...
**Files likely touched:**
- `projects/wind-daq/apps/desktop-wails/frontend/src/views/traversal/TraversalStatusView.vue`
