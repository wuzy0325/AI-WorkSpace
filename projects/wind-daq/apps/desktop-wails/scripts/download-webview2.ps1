...
# NSIS installer's online WebView2 bootstrapper download often fails, leaving Wind-DAQ
...
#   3. Copy build\bin\wind-daq-*.exe and build\bin\MicrosoftEdgeWebView2RuntimeInstallerX64.exe
...
$webClient.Headers.Add('User-Agent', 'Wind-DAQ-Installer-Script/1.0')
