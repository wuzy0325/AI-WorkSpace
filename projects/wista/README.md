...
业务 bug 必须优先在主线修复，再通过 `git cherry-pick -x <commit>` 或兼容移植回移到 Win7 分支；不要将 `master` 整体 merge 到 Win7 分支。DAQ-T1603 技术基线见 `docs/decisions/ADR-007-wista-win7-lts.md`，全工作空间组织与同步规则见 `docs/decisions/ADR-008-workspace-win7-lts-worktree.md`。
