...
This file is the project-level startup entrypoint for WISTA.
...
5. `CLAUDE.md` — WISTA single-module architecture and project-specific hard constraints
...
WISTA is a standalone Wails desktop application for:

- device profile management
- WISTA acquisition and monitoring
- CSV recording
