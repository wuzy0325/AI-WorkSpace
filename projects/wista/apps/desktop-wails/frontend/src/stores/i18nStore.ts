...
const zh = {
  ...
  'dialog.scanSubtitle': '局域网中发现 WISTA 设备',
...
const en = {
  ...
  // ---- app-level ----
  'app.windowTitle': 'WISTA Temperature Acquisition',
  'app.confirmExitTitle': 'Exit Application',
  'app.confirmExitText': 'Exit WISTA? Any in-progress recording will be flushed and closed.',
  'app.exit': 'Exit',
  ...
  'sidebar.addHint': 'Click + in the top bar to add a T1603',
  ...
  'dialog.scanSubtitle': 'Discover WISTA devices on the LAN',
