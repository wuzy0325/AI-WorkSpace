...
- **零回归硬门槛**：Phase 2/3 每个 Task 的验证必须包含 `cd projects\WindLabX4\services\api-go; go test ./internal/...` 全量通过；任何既有测试失败即阻塞，不得跳过。
...
- **只读区**：`device-lab/skills/seven-hole-probe/seven_hole.py` 与数据集 `projects/WindLabX4/docs/W532.202608.P.7H.1-01/` 原文件只读（Task 6 新增的夹具脚本与转码副本除外）。
...
- [ ] `cd projects\WindLabX4\services\api-go; go build ./...`
...
- `go.work`
- `projects/WindLabX4/services/api-go/go.mod`
...
## Phase 2：后端集成（`projects/WindLabX4/services/api-go`）
...
- [ ] `cd projects\WindLabX4\services\api-go; go test ./internal/core/... -run TestTraversal -v`
- [ ] `cd projects\WindLabX4\services\api-go; go test ./internal/...` 全量零回归
...
- [ ] `cd projects\WindLabX4\services\api-go; go test ./internal/usecase/... -run 'TestBuildRawPressure|TestCalculateRealtime|TestCheckPreconditions|TestInterpolatorIdentity' -v`
- [ ] `cd projects\WindLabX4\services\api-go; go test ./internal/...` 全量零回归
...
- [ ] `cd projects\WindLabX4\services\api-go; go test ./internal/adapters/interpolation/... -v`
- [ ] `cd projects\WindLabX4\services\api-go; go test ./internal/...` 全量零回归
...
- [ ] `cd projects\WindLabX4\services\api-go; go test ./internal/usecase/... -run 'TestParseConfig|TestRestore|TestRoleToLabel' -v`
- [ ] `cd projects\WindLabX4\services\api-go; go test ./internal/...` 全量零回归
...
- [ ] `cd projects\WindLabX4\services\api-go; go test ./internal/adapters/storage/... -run 'TestTraversalCSV|TestBuildHeader|TestBuildLabelEntries' -v`
- [ ] `cd projects\WindLabX4\services\api-go; go test ./internal/...` 全量零回归
...
- [ ] `cd projects\WindLabX4\services\api-go; go test ./api/... -run 'TestTraversal|TestImportSevenHole|TestCalculateRealtime' -v`
- [ ] `cd projects\WindLabX4\services\api-go; go test ./internal/...; go test ./api/...` 全量零回归
...
- [ ] `cd projects\WindLabX4\services\api-go; go test ./...` 全量全绿（含全部既有五孔用例）
...
- [ ] `cd projects\WindLabX4\services\api-go; go test ./...` 全绿
- [ ] `cd projects\WindLabX4\apps\desktop-wails\frontend; npm run typecheck; npm run build` 零错误
...
- 数据集：`projects/WindLabX4/docs/W532.202608.P.7H.1-01/`（GBK，只读）
