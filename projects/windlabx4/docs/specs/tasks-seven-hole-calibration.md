...
**Verification:**
- [ ] 测试通过：`cd projects\WindLabX4\services\api-go; go test ./internal/core/calibration/...`
...
- `projects/WindLabX4/services/api-go/internal/core/calibration/types.go`
- `projects/WindLabX4/services/api-go/internal/core/calibration/types_test.go`（新增七孔类型序列化测试）
...
**Files likely touched:**
- `projects/WindLabX4/services/api-go/internal/core/calibration/seven_hole_formulas.go`（新增）
- `projects/WindLabX4/services/api-go/internal/core/calibration/seven_hole_formulas_test.go`（新增）
...
**Files likely touched:**
- `projects/WindLabX4/services/api-go/internal/core/calibration/seven_hole.go`（新增）
- `projects/WindLabX4/services/api-go/internal/core/calibration/seven_hole_test.go`（新增分区判定测试）
...
**Files likely touched:**
- `projects/WindLabX4/services/api-go/internal/core/calibration/seven_hole_uncertainty.go`（新增）
- `projects/WindLabX4/services/api-go/internal/core/calibration/seven_hole_uncertainty_test.go`（新增）
...
- [ ] `cd projects\WindLabX4\services\api-go; go test ./internal/core/calibration/...` 全绿
...
**Files likely touched:**
- `projects/WindLabX4/services/api-go/internal/core/calibration/seven_hole.go`
- `projects/WindLabX4/services/api-go/internal/core/calibration/seven_hole_test.go`
...
**Files likely touched:**
- `projects/WindLabX4/services/api-go/internal/core/calibration/seven_hole.go`
- `projects/WindLabX4/services/api-go/internal/core/calibration/seven_hole_points_test.go`（新增点位生成测试）
...
**Files likely touched:**
- `projects/WindLabX4/services/api-go/internal/core/calibration/csv_schema.go`
- `projects/WindLabX4/services/api-go/internal/core/calibration/csv_schema_test.go`
...
**Files likely touched:**
- `projects/WindLabX4/services/api-go/internal/adapters/config/calibration_config_decoder_test.go`（新增七孔 DTO 集成测试）
...
**Files likely touched:**
- `projects/WindLabX4/services/api-go/internal/usecase/calibration.go`
- `projects/WindLabX4/services/api-go/internal/usecase/calibration_test.go`
...
**Files likely touched:**
- `projects/WindLabX4/services/api-go/internal/core/calibration/automatic_calibration.go`
- `projects/WindLabX4/services/api-go/internal/core/calibration/automatic_calibration_test.go`
...
- `projects/WindLabX4/services/api-go/internal/core/calibration/types.go`
- `projects/WindLabX4/services/api-go/internal/core/calibration/automatic_calibration.go`
- `projects/WindLabX4/services/api-go/internal/adapters/event/calibration_event_publisher.go`（或类似文件，补全 OnRegionChanged 实现）
...
**Files likely touched:**
- `projects/WindLabX4/services/api-go/api/server.go`
- `projects/WindLabX4/services/api-go/api/server_test.go`（或新增 handler 测试文件）
...
**Verification:**
- [ ] Build 成功：`cd projects\WindLabX4\apps\desktop-wails\backend; go build ./...`
- [ ] Wails binding 生成：`wails3 generate bindings -silent`
- [ ] 前端 TS 类型检查：`cd projects\WindLabX4\apps\desktop-wails\frontend; npm run typecheck`
...
- `projects/WindLabX4/pkg/types/calibration.go`（或类似公共类型文件，新增 SevenHoleConfigDTO 别名）
...
- [ ] `cd projects\WindLabX4\apps\desktop-wails\backend; go build ./...` 成功
...
**Files likely touched:**
- `projects/WindLabX4/services/api-go/internal/core/calibration/seven_hole_dataset_regression_test.go`（新增）
- `projects/WindLabX4/services/api-go/internal/core/calibration/testdata/seven_hole/`（新增数据集 fixture 目录）
...
**Files likely touched:**
- `projects/WindLabX4/services/api-go/internal/core/calibration/seven_hole_formulas_test.go`（追加黄金用例测试）
...
**Files likely touched:**
- `projects/WindLabX4/services/api-go/internal/core/calibration/seven_hole_test.go`（追加 tie-break 测试）
...
**Files likely touched:**
- `projects/WindLabX4/services/api-go/internal/core/calibration/seven_hole_uncertainty_test.go`（追加 7 步算例测试）
...
**Verification:**
- [ ] TypeScript 类型检查：`cd projects\WindLabX4\apps\desktop-wails\frontend; npm run typecheck`
...
**Files likely touched:**
- `projects/WindLabX4/apps/desktop-wails/frontend/src/api/calibrationApi.ts`
- `projects/WindLabX4/apps/desktop-wails/frontend/src/shared/types/calibration.ts`（新增七孔 TS 类型）
...
**Files likely touched:**
- `projects/WindLabX4/apps/desktop-wails/frontend/src/stores/calibrationStore.ts`
- `projects/WindLabX4/apps/desktop-wails/frontend/src/shared/types/calibration.ts`
...
**Files likely touched:**
- `projects/WindLabX4/apps/desktop-wails/frontend/src/components/calibration/seven-hole/SevenHoleSettings.vue`（新增）
- `projects/WindLabX4/apps/desktop-wails/frontend/src/components/calibration/seven-hole/SevenHoleSettings.spec.ts`（新增单元测试，可选）
...
**Files likely touched:**
- `projects/WindLabX4/apps/desktop-wails/frontend/src/components/calibration/seven-hole/SevenHoleMain.vue`（新增）
...
**Files likely touched:**
- `projects/WindLabX4/apps/desktop-wails/frontend/src/components/calibration/seven-hole/SevenHoleCharts.vue`（新增）
- `projects/WindLabX4/apps/desktop-wails/frontend/src/composables/useThrottledChartUpdate.ts`（若不存在则新增，参考 project_memory §54）
...
**Files likely touched:**
- `projects/WindLabX4/apps/desktop-wails/frontend/src/components/calibration/seven-hole/SevenHoleMain.vue`
- `projects/WindLabX4/apps/desktop-wails/frontend/src/stores/calibrationStore.ts`（追加 OnRegionChanged 订阅逻辑）
- `projects/WindLabX4/apps/desktop-wails/frontend/src/api/calibrationApi.ts`（追加事件订阅辅助函数，可选）
...
**Files likely touched:**
- `projects/WindLabX4/apps/desktop-wails/frontend/src/stores/calibrationStore.ts`（追加七孔状态恢复逻辑）
- `projects/WindLabX4/apps/desktop-wails/frontend/src/components/calibration/CalibrationWindow.vue`（追加七孔落点决策与跨类型切换保护）
- `projects/WindLabX4/apps/desktop-wails/frontend/src/components/calibration/CalibrationHome.vue`（追加七孔卡片入口）
...
- [ ] WindLabX4 全量构建与测试通过：`go build` + `go test` + `go vet` + `npm typecheck` + `npm build`
- [ ] 人工最终 review：可发布
...
- 数据集验证：`projects/WindLabX4/docs/W532.202608.P.7H.1-01/`（85 m/s，Ma≈0.242，481 个点位）
