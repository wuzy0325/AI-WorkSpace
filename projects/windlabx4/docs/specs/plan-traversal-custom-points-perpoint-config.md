...
> 关联 spec：[spec-traversal-custom-points-perpoint-config.md](file:///c:/Users/wuzhy/Documents/D/SVN/SoftWare/trunk/AI-Workspace/projects/WindLabX4/docs/specs/spec-traversal-custom-points-perpoint-config.md)
> 日期：2026-07-20
> 状态：待执行
...
- `projects/WindLabX4/services/api-go/internal/usecase/traversal_perpoint_config_test.go`（新增）
...
**Files**:
- `projects/WindLabX4/apps/desktop-wails/frontend/src/shared/pointsFileParser.ts`
- `projects/WindLabX4/apps/desktop-wails/frontend/src/shared/__tests__/pointsFileParser.test.ts`
...
**Files**:
- `projects/WindLabX4/apps/desktop-wails/frontend/src/components/traversal/CustomPointsTable.vue`
...
**Verify**:
- `cd projects\WindLabX4\services\api-go && go build -buildvcs=false ./...` 通过
- `cd projects\WindLabX4\services\api-go && go vet ./...` 通过
- `cd projects\WindLabX4\services\api-go && go test ./internal/...` 通过
- `cd projects\WindLabX4\apps\desktop-wails\frontend && npm run typecheck` 通过
- `cd projects\WindLabX4\apps\desktop-wails\frontend && npm run build` 通过
- `cd projects\WindLabX4\apps\desktop-wails\frontend && npm run test` 通过
