...
> 关联 spec：[spec-traversal-pressure-normalize.md](file:///C:/Users/wuzhy/Documents/D/SVN/SoftWare/trunk/AI-Workspace/projects/windlabx4/docs/specs/spec-traversal-pressure-normalize.md)
> 日期：2026-07-10
> 状态：待审批
...
- `projects/windlabx4/services/api-go/internal/core/device/unit_converter.go`
- `projects/windlabx4/services/api-go/internal/core/device/unit_converter_test.go`（若不存在则新建）
...
**Files likely touched:**
- `projects/windlabx4/services/api-go/internal/core/pressure/normalize.go`（新建）
- `projects/windlabx4/services/api-go/internal/core/pressure/normalize_test.go`（新建）
...
- `projects/windlabx4/services/api-go/internal/usecase/traversal_config_test.go`（追加旧配置兜底用例）
...
- `projects/windlabx4/services/api-go/internal/usecase/device_manager_test.go`（追加测试）
...
**Files likely touched:**
- `projects/windlabx4/services/api-go/internal/usecase/traversal_view.go`
- `projects/windlabx4/services/api-go/internal/usecase/traversal_view_test.go`（若不存在则新建）
...
**Files likely touched:**
- `projects/windlabx4/services/api-go/internal/usecase/traversal.go`
- `projects/windlabx4/services/api-go/internal/usecase/traversal_test.go`（追加测试）
...
**Files likely touched:**
- `projects/windlabx4/services/api-go/internal/bootstrap/bootstrap.go`
- `projects/windlabx4/services/api-go/pkg/apiserver/apiserver.go`
- `projects/windlabx4/services/api-go/pkg/appcontext/context.go`
...
- `projects/windlabx4/apps/desktop-wails/frontend/src/stores/i18n.ts`（追加 i18n key）
...
**Files likely touched:**
- `projects/windlabx4/apps/desktop-wails/frontend/src/components/traversal/TraversalHardwareStep.vue`
- `projects/windlabx4/apps/desktop-wails/frontend/src/stores/i18n.ts`（追加提示文案）
...
**Files likely touched:**
- `projects/windlabx4/apps/desktop-wails/frontend/src/components/traversal/TraversalMain.vue`（可能）
- `projects/windlabx4/apps/desktop-wails/frontend/src/components/traversal/TraversalLiveMonitor.vue`（可能）
- 其他 grep 命中文件
