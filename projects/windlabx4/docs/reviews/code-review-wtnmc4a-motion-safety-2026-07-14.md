...
| `projects/WindLabX4/docs/specs/spec-traversal-motion-safety.md` | 新增 | 遍历运动安全防护规格文档 |
...
- **spec 要求**（[spec-traversal-motion-safety.md:318](file:///c:/Users/wuzhy/Documents/D/SVN/SoftWare/trunk/AI-Workspace/projects/WindLabX4/docs/specs/spec-traversal-motion-safety.md#L318)）："急停逐台尝试；任一失败仍继续停止其它控制器并执行轴级 Stop 兜底" — 即"失败也锁存"
