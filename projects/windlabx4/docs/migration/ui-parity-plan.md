...
This document is the implementation guide for AI agents rebuilding `Cursor DAQ` as `WindLabX4`.

The work is not a redesign. `WindLabX4` is the refactored successor of the pre-refactor `Cursor DAQ`: the backend moves to Go/Wails and the internal architecture must improve, while the user-facing frontend remains visually and interactively consistent with the old project.

## Product Positioning

`WindLabX4` is a refactor of the reference project, not a different product.
...
```text
C:\Users\wuzhy\Documents\D\SVN\SoftWare\trunk\AI-Workspace\projects\WindLabX4\apps\desktop-wails\frontend
```
...
- `projects/windlabx4/apps/desktop-wails/frontend/dist`
- Any new generated design ideas
- Generic dashboard/SCADA UI assumptions

## Definition Of Done

The implementation is done when a user familiar with `Cursor DAQ` sees `WindLabX4` and recognizes the old UI structure and styling.
...
```text
windlabx4/apps/desktop-wails/frontend/src/views/main/MainLayout.vue
windlabx4/apps/desktop-wails/frontend/src/views/main/MainDashboardView.vue
windlabx4/apps/desktop-wails/frontend/src/views/MainView.vue
windlabx4/apps/desktop-wails/frontend/src/components/layout/MainTopBar.vue
windlabx4/apps/desktop-wails/frontend/src/components/layout/AppRailNav.vue
windlabx4/apps/desktop-wails/frontend/src/components/layout/MainBottomBar.vue
windlabx4/apps/desktop-wails/frontend/src/components/layout/AppShell.vue
windlabx4/apps/desktop-wails/frontend/src/components/layout/GlobalSettingsModal.vue
windlabx4/apps/desktop-wails/frontend/src/components/main/DeviceSidebar.vue
windlabx4/apps/desktop-wails/frontend/src/components/main/DeviceOverviewPanel.vue
windlabx4/apps/desktop-wails/frontend/src/components/main/DeviceDetailPanel.vue
windlabx4/apps/desktop-wails/frontend/src/views/MotionView.vue
windlabx4/apps/desktop-wails/frontend/src/views/CalibrationView.vue
windlabx4/apps/desktop-wails/frontend/src/views/TraversalView.vue
windlabx4/apps/desktop-wails/frontend/src/views/LogViewer.vue
windlabx4/apps/desktop-wails/frontend/src/styles.css
windlabx4/apps/desktop-wails/frontend/src/styles/**
windlabx4/apps/desktop-wails/frontend/src/router/index.ts
```
...
1. `docs(WindLabX4): define cursor daq ui parity plan`
2. `refactor(WindLabX4-ui): restore cursor daq shell structure`
3. `refactor(WindLabX4-ui): align topbar rail and dashboard panels`
4. `refactor(WindLabX4-ui): embed secondary pages in main shell`
5. `style(WindLabX4-ui): align theme tokens with cursor daq`
6. `test(WindLabX4-ui): update parity coverage`
