...
//
// 数据源：
//   GBK 原始：projects/windlabx4/docs/W532.202608.P.7H.1-01/*.csv
...
//   .../projects/windlabx4/services/api-go/internal/usecase/calibration_seven_hole_dataset_regression_test.go
...
func sevenHoleFixtureDir(t *testing.T) string {
	...
	// thisFile = .../AI-Workspace/projects/windlabx4/services/api-go/internal/usecase/calibration_seven_hole_dataset_regression_test.go
	// 向上跳 7 次：usecase → internal → api-go → services → windlabx4 → projects → AI-Workspace
	root := thisFile
	for i := 0; i < 7; i++ {
