// Package logging 提供 windlabx4 项目统一的结构化日志基础设施。
//
// 设计目标：
...
type Options struct {
	...
	LogDir string
	// FileBaseName 日志文件基础名，最终文件形如 {FileBaseName}-YYYYMMDD.log；为空时取 "windlabx4"。
	FileBaseName string
...
// dailyRotatingWriter 按天切换文件，文件命名 windlabx4-YYYYMMDD.log。
