...
//   1) projects/windlabx4/apps/desktop-wails/config/device-profiles.json
//   2) projects/windlabx4/services/api-go/config/device-profiles.json
//   3) projects/windlabx4/services/api-go/pkg/apiserver/config/device-profiles.json
  ...
  subscribeToDevice: (deviceId: string, owner = 'default'): void => {
    ...
    subscription = subscribeDaqStream(
      ...
      (error) => {
        ...
        // 通知后由 deviceStore 通过 unsubscribeAllFromDevice 统一清理订阅
