# WindLabX4 Design Token Rules

> `styles/tokens/` is the visual source of truth for WindLabX4. UI work must use these tokens before adding local values.
...
WindLabX4 is a desktop-first industrial DAQ UI. Token usage should preserve:
