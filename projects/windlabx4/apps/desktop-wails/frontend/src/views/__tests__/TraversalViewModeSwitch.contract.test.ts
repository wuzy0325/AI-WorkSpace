 ...
 *   1. mode 持久化到 localStorage（键 WindLabX4.traversal.mode）
...
describe('Traversal mode switch gate (store + nav submenu)', () => {
  ...
  it('mode 持久化到 localStorage 键 WindLabX4.traversal.mode', () => {
    expect(storeSource).toContain("'WindLabX4.traversal.mode'")
