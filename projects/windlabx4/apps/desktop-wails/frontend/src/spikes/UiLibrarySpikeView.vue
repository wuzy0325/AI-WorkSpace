...
const scoreRows = [
  ...
  { label: '视觉来源', value: 'Naive token 由 windlabx4 token 映射' },
  ...
  <NaiveThemeProvider :theme="themeStore.theme">
    <div class="ui-spike-shell">
      <header class="ui-spike-header">
        <div>
          <p class="ui-spike-kicker">windlabx4 UI Library Spike</p>
      ...
      <main class="ui-spike-main">
        ...
        <section class="ui-spike-notes" aria-label="应用建议">
          <h2>应用建议</h2>
          <p>Naive UI 已按 windlabx4 当前主题系统接入。浅色/深色切换仍以 `themeStore` 和项目 CSS token 为准。</p>
