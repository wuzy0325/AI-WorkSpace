...
func TestWSHub_EmitDelivered(t *testing.T) {
	...
	if dataMap["message"] != "DAQ-P-1604 application started" {
		t.Errorf("message = %v, want 'DAQ-P-1604 application started'", dataMap["message"])
	}
}
...
//
// 设计动机：daq-p1604 的 EmitDeviceState 推送 (id, state) 双参数，
