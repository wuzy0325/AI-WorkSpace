...
//
// 与 daq-t1603 httpserver 的差异：
//   - Server 持有 *backend.App 单体（daq-t1603 持有 3 个 Service）
//   - 多了 latest-snapshot 端点（daq-p1604 前端 500ms 轮询读取快照）
//   - 多了 start-with-config 端点（daq-p1604 录制带 FileRotation + StopConditions）
