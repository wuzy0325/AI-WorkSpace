...
KNOWN_IP = os.environ.get("DAQ_P1604_TEST_IP", "192.168.1.7")
KNOWN_PORT = int(os.environ.get("DAQ_P1604_TEST_PORT", "9000"))
KNOWN_NAME = os.environ.get("DAQ_P1604_TEST_NAME", "DAQ-P-1604-374D87")
