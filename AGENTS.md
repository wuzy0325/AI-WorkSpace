...
This project is indexed by GitNexus as **AI-WorkSpace** (6562 symbols, 16428 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
